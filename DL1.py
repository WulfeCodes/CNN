...
class outputFilter1:
    ...
    def backwardMatrices(self,input,losses,index):
        ...
        for i in range(self.output_dims):
            for j in range(self.output_dims):
                ...
                temp[i:i+self.filter_kernal_dims, j:j+self.filter_kernal_dims] += input * (losses[i,j]* self.leaky_relu_derivative(index[i,j]))
...
if __name__=="__main__":
    ...
    for i in range(epochs):
        ...
        for k in range(o.filter_num):
            ...
            o.OutList[k]=o.forward(train_images[i],o.filterList[k])
        ...
        for k in range(o1.filter_num):
            ...
            for z in range(p.filter_num):
                ...
                tempMatrix+=o1.forward(p.OutList[z],o1.filterList[k])
